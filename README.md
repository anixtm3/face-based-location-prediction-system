...
- [Overview](https://github.com/anixtm3/face-based-location-prediction-system#overview)
- [Objectives](https://github.com/anixtm3/face-based-location-prediction-system#objectives)
- [Core Idea](https://github.com/anixtm3/face-based-location-prediction-system#core-idea)
- [How the system works](https://github.com/anixtm3/face-based-location-prediction-system#how-the-system-works)
- [Project Structure](https://github.com/anixtm3/face-based-location-prediction-system#project-structure)
- [Dataset Description](https://github.com/anixtm3/face-based-location-prediction-system#dataset-description)
- [System Architecture](https://github.com/anixtm3/face-based-location-prediction-system#system-architecture)
- [identity_mobility.csv (Design)](https://github.com/anixtm3/face-based-location-prediction-system#identity_mobilitycsv-design)
  - [Schema](https://github.com/anixtm3/face-based-location-prediction-system#schema)
    - [Example](https://github.com/anixtm3/face-based-location-prediction-system#example)
- [Technologies Used](https://github.com/anixtm3/face-based-location-prediction-system#technologies-used)
  - [Python Version Requirement](https://github.com/anixtm3/face-based-location-prediction-system#python-version-requirement)
    - [Important](https://github.com/anixtm3/face-based-location-prediction-system#important)
    - [Recommended Version](https://github.com/anixtm3/face-based-location-prediction-system#recommended-version)
- [How to run](https://github.com/anixtm3/face-based-location-prediction-system#how-to-run)
  - [Step 1](https://github.com/anixtm3/face-based-location-prediction-system#step-1-clone-the-repository)
  - [Step 2](https://github.com/anixtm3/face-based-location-prediction-system#step-2-create-and-activate-a-virtual-environment)
    - [Windows](https://github.com/anixtm3/face-based-location-prediction-system#windows)
    - [Linux/MacOS](https://github.com/anixtm3/face-based-location-prediction-system#linuxmacos)
  - [Step 3](https://github.com/anixtm3/face-based-location-prediction-system#step-3-install-dependencies)
  - [Step 4](https://github.com/anixtm3/face-based-location-prediction-system#step-4-set-up-the-data-directory)
  - [Step 5](https://github.com/anixtm3/face-based-location-prediction-system#step-5-add-raw-face-images)
  - [Step 6](https://github.com/anixtm3/face-based-location-prediction-system#step-6-generate-face-embeddings)
  - [Step 7](https://github.com/anixtm3/face-based-location-prediction-system#step-7-configure-spatiotemporal-behavior)
  - [Step 8](https://github.com/anixtm3/face-based-location-prediction-system#step-8-run-the-real-time-system)
  - [Step 9](https://github.com/anixtm3/face-based-location-prediction-system#step-9-controls)
- [Output](https://github.com/anixtm3/face-based-location-prediction-system#output)
- [Limitations](https://github.com/anixtm3/face-based-location-prediction-system#limitations)
- [Ethical Considerations](https://github.com/anixtm3/face-based-location-prediction-system#ethical-considerations)
- [Conclusion](https://github.com/anixtm3/face-based-location-prediction-system#conclusion)
- [Author](https://github.com/anixtm3/face-based-location-prediction-system#conclusion)
